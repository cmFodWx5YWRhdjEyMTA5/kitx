...
public class ViewExt {
    ...
    public static ViewExt build(androidx.fragment.app.Fragment fragment) {
        Empty.checkNull(fragment);
        View view = fragment.getView();
        if (view == null) {
            throw new IllegalArgumentException(ERRORUSE);
    ...
    public static <T extends View> T find(androidx.fragment.app.Fragment fragment, @IdRes int id) {
        Empty.checkNull(fragment);
        Empty.checkNull(fragment.getView(), ERRORUSE);
        return find(fragment.getView(), id);
    }
    ...
    public static <T extends View> T find(androidx.fragment.app.Fragment fragment, @IdRes int id, View.OnClickListener listener) {
        T t = find(fragment, id);
        if (t != null) {
            t.setOnClickListener(listener);
        }
